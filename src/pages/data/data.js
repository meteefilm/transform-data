                                ...
                                <div className="p-fluid formgrid grid ">
                                    <div className={'field col-12 ' + (typeTran === 'file' ? 'md:col-6' : 'md:col-12')}>
                                        ...
                                        {typeTran === 'file' && (
                                            <Button
                                                className={classNames(
                                                    ...
                                                    { 'p-button-secondary': transDataView === 'text' },
                                                    { 'p-button-success': transDataView === 'list' && transData !== '' },
                                                    { 'p-button-secondary': transData === '' }
                                                )}
                                                onClick={() => setTransDataView('list')}
                                                icon="pi pi-list"
                                                disabled={transData === ''}
                                            />
                                        )}
                                        <Button
                                            className={classNames(
                                                'p-button-outlined w-3rem mb-2 mr-2 ',
                                                { 'p-button-secondary': transDataView === 'list' },
                                                { 'p-button-success': transDataView === 'text' && transData !== '' },
                                                { 'p-button-secondary': transData === '' }
                                            )}
                                            onClick={() => setTransDataView('text')}
                                            icon="pi pi-code"
                                            disabled={transData === ''}
                                        />
